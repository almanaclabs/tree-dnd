...
export var getFlatItemPath = function (flattenedTree, sourceIndex) { return flattenedTree[sourceIndex].path; };
/*
...
/*
   ...
   */
export var getDestinationPath = function (flattenedTree, sourceIndex, destinationIndex, 
...
export var getItemById = function (flattenedTree, id) {
    return flattenedTree.find(function (item) { return item.item.id === id; });
};
export var getIndexById = function (flattenedTree, id) { return flattenedTree.findIndex(function (item) { return item.item.id === id; }); };
