    ...
    function Tree() {
        ...
        _this.dropPlaceholderPos = function (draggableId, sourceIdx, destinationIdx) {
            ...
            if (destinationIdx === undefined) {
                var _a = css_box_model_1.getBox(draggable).marginBox, top_1 = _a.top, left_1 = _a.left, height_1 = _a.height, width_1 = _a.width;
            ...
            var _b = css_box_model_1.getBox(_this.containerElement).marginBox, left = _b.left, rootTop = _b.top;
            var top = children
                .slice(0, destinationIdx)
                .reduce(function (acc, child) { return acc + css_box_model_1.getBox(child).marginBox.height; }, rootTop);
            var _c = css_box_model_1.getBox(draggable).marginBox, height = _c.height, width = _c.width;
